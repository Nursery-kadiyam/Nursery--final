-- COMPREHENSIVE FIX FOR QUOTATION TO ORDER DATA FLOW
...
-- ========================================
-- 5. UPDATE MERCHANT ORDERS FUNCTION
-- ========================================
            ...
            jsonb_agg(
                jsonb_build_object(
                    ...
                    'product_name', COALESCE(
                        ...
                        oi.product_name,            -- Then stored product name
                    ...
                    'product_image', COALESCE(
                        ...
                        oi.product_image,            -- Then stored product image
...
-- ========================================
-- 6. UPDATE ORDER DETAILS FUNCTION
-- ========================================
