-- FIX MERCHANT PRIVACY RLS POLICIES - CORRECTED FOR ACTUAL SCHEMA
...
-- 8. Create merchant-specific order function with privacy protection (CORRECTED TYPES)
...
-- 9. Create function to get specific order details for merchant (CORRECTED TYPES)
