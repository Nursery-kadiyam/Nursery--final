...
-- This fixes the image flickering by properly extracting images from quotation data

-- ========================================
-- 1. UPDATE EXISTING ORDER_ITEMS WITH QUOTATION IMAGES
-- ========================================
UPDATE order_items 
...
-- ========================================
-- 2. UPDATE MERCHANT ORDERS FUNCTION TO EXTRACT IMAGES FROM QUOTATION SPECIFICATIONS
-- ========================================
...
-- ========================================
-- 3. UPDATE ORDER DETAILS FUNCTION TO EXTRACT IMAGES FROM QUOTATION SPECIFICATIONS
-- ========================================
