-- Fix Merchant Order Display - Corrected Version
...
-- ========================================
-- 3. CREATE MISSING ORDER CODES (FIXED)
-- ========================================

-- Generate order codes for orders that don't have them (using correct PostgreSQL syntax)
UPDATE orders 
