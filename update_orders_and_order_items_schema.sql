-- UPDATE ORDERS AND ORDER_ITEMS TABLES WITH NEW SCHEMA
...
-- ========================================
-- 7. RESTORE ORDERS DATA
-- ========================================
SELECT '=== RESTORING ORDERS DATA ===' as section;

-- Insert data from backup, mapping old columns to new schema
INSERT INTO orders (
    id,
    user_id,
    delivery_address,
