-- Simple Database Setup for Enhanced Merchant Dashboard
...
VALUES ('Q123', 'MC-2025-0002', '00000000-0000-0000-0000-000000000000', 1500.00, 'delivered')
ON CONFLICT DO NOTHING;

INSERT INTO reviews (merchant_code, user_id, rating, comment, customer_name)
VALUES ('MC-2025-0002', '00000000-0000-0000-0000-000000000000', 5, 'Great service and quality plants!', 'John Doe')
ON CONFLICT DO NOTHING;
