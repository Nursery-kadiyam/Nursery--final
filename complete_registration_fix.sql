...
-- This addresses ALL possible causes of registration errors (422, 500, etc.)
...
-- Create a fresh, clean user_profiles table with proper structure
...
DECLARE
    ...
    test_email TEXT := 'complete_test@example.com';
BEGIN
...
-- Final status
SELECT '=== COMPLETE FIX FINISHED ===' as status;
