...
import { Package, Eye, Clock, CheckCircle, X, Truck, MapPin, Calendar, User, Phone, Mail, Store, ChevronDown, ChevronUp, RefreshCw } from "lucide-react";
...
const FixedMerchantDashboard: React.FC = () => {
                      ...
                      <div className="flex items-center space-x-4">
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            Merchant: {order.merchant_code} (ID: {order.merchant_id || 'N/A'})
                          </p>
                        </div>
...
export default FixedMerchantDashboard;