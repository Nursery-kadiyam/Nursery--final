                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="mt-4">
                                <h3 className="text-lg font-semibold text-emerald-800 mb-2">Review Images</h3>
                                <div className="flex gap-3">
                                    {[
                                        "photo-1506744038136-46273834b3fb",
                                        "photo-1465101046530-73398c7f28ca",
                                        "photo-1468779060412-f5b0904f65b0",
                                        "photo-1518709268805-4e9042af2176"
                                    ].map((img, idx) => (
                                        <img
                                            key={idx}
                                            src={`https://images.unsplash.com/${img}?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80`}
                                            alt={`Review ${idx + 1}`}
                                            className="w-20 h-20 object-cover rounded-lg border border-emerald-100 shadow-sm"
                                        />
                                    ))}
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center border border-emerald-200 rounded-lg">
                                            <input
                                                ...
                                                className="w-16 text-center text-lg font-semibold border-0 focus:ring-0 focus:outline-none"
